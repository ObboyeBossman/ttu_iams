  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        // Super Admin
        'super-admin-dashboard':     path.resolve(root, 'src/modules/super_admin/dashboard/dashboard.html'),
        'super-admin-structure':     path.resolve(root, 'src/modules/super_admin/structure/structure.html'),
        'super-admin-students':      path.resolve(root, 'src/modules/super_admin/students/students.html'),
        'super-admin-supervisors':   path.resolve(root, 'src/modules/super_admin/supervisors/supervisors.html'),
        'super-admin-admins':        path.resolve(root, 'src/modules/super_admin/admins/admins.html'),
        'super-admin-system-audit':  path.resolve(root, 'src/modules/super_admin/system-audit/system-audit.html'),
        'super-admin-system-health': path.resolve(root, 'src/modules/super_admin/system-health/system-health.html'),
        'super-admin-settings':      path.resolve(root, 'src/modules/super_admin/settings/settings.html'),
      },
    },
  },
