...
function init() {
  // Register submit listener synchronously to prevent default browser GET submits
  const form = document.getElementById('public-letter-form');
  if (form) {
    form.addEventListener('submit', handleSubmit);
  }

  // Pre-fetch season in background
  fetchSeason();
}
...
async function handleSubmit(e) {
  ...
  try {
    ...
    const payload = { formData, studentProfile, season };
